...
const FCFA_PRICES: Record<string, number> = {
  ...
  "/cours/gestion-des-parties-prenantes-networking-diplomatique-pour-les-dirigeants": 29000,
  ...
  "/cours/modelisation-maitrise-financieres-pour-les-dirigeants": 29900,
...
function formatPriceFCFA(price: string, href?: string): string {
  // Priorité : prix officiel depuis le mapping
  ...
  // Conversion approximative si $ présent
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-base font-bold text-gray-900">{formatPriceFCFA(course.price, course.href)}</p>
      </div>
    </a>
  );
}
