    ...
    body: (
      <>
        <p className="mb-4">
          ...
          , est éditée par <strong>H&amp;C DIGITAL FLIX LLC</strong>
    ...
    body: (
      <>
        <p className="mb-4">
          ...
          de <strong>MANAGERSITY by H&amp;C</strong> éditer par <strong>H&amp;C DIGITAL FLIX LLC</strong>,
        ...
        <ul className="space-y-2 mb-4">
          {[
            ...
            "Utiliser les contenus à des fins commerciales sans accord contractuel avec H&C DIGITAL FLIX LLC.",
          ].map((item) => (
            <li key={item} className="flex gap-2">
              <span className="text-[#c4a800] font-bold">•</span>
              <span>{item}</span>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          Les certifications sont délivrées par <strong>H&amp;C DIGITAL FLIX LLC</strong> et{" "}
          <strong>H&amp;C Executive Education</strong>, entités du H&amp;C DIGITAL FLIX LLC, partenaire de
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          Les présentes CGU sont régies par les lois applicables au siège social de H&amp;C
          DIGITAL FLIX LLC. En cas de litige, les parties s&apos;efforceront de trouver une solution amiable
