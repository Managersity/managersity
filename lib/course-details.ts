...
export const COURSES: CourseDetail[] = [
  ...
  },
  {
    ...
    learns: [
      ...
      "Développer son intelligence émotionnelle et gérer ses relations",
      "Piloter la transformation et le changement organisationnel",
      "Optimiser sa gestion du temps et sa discipline personnelle",
      "Développer son potentiel et se mettre à la dimension de ses ambitions",
    ],
    bundledCourses: [
      {
      ...
      },
      {
        ...
        img: "/cours/developper-potentiel.png",
        price: 11990,
        tagline: "Prendre en main sa carrière, débloquer son plein potentiel et construire la vie et la carrière que l'on mérite vraiment.",
      },
      {
        ...
        price: 34900,
        tagline: "Les nouveaux leviers d'influence et d'affirmation de l'autorité pour les managers et leaders du 21e siècle.",
      },
      {
        title: "Intelligence Émotionnelle & Gestion des Relations avec les Autres",
        slug: "intelligence-emotionnelle-gestion-des-relations-avec-les-autres",
        img: "/cours/intelligence-emotionnelle.png",
        price: 14900,
        tagline: "Maîtriser ses émotions, développer son self-management et bâtir des relations professionnelles solides.",
      },
      {
        ...
        img: "/cours/gestion-temps-discipline.png",
        price: 19900,
        tagline: "29 méthodes inédites pour massacrer la procrastination, s'organiser et délivrer des performances records.",
      },
    ],
  },
  {
  ...
  // ── REPLAY CLASSES DIGITALES ────────────────────────────────────────────────
  {
    ...
    totalLessons: 48,
    learns: [
      "Accéder à 48 replays de sessions live sur le management, le leadership et l'IA",
    ...
    chapters: [
      "Classe Digitale Gestion de Temps",
      "Classe Digitale L'Art de la Délégation Efficace",
      "Classe Digitale Réussir sa Prise de Fonction",
      "Classe Digitale Optimiser son Équipe",
      "Classe Digitale Leadership Attractif",
      "Classe Digitale Manager Efficacement sa Carrière",
      "Classe Digitale Faire son Bilan Managerial",
      "Classe Digitale Optimiser sa Fluidité Relationnelle",
      "Classe Digitale Atteindre les Objectifs Commerciaux",
      "Classe Digitale Éliminer la Procrastination",
      "Classe Digitale Animation Efficace d'Équipe",
      "Classe Digitale L'Art de se Recréer",
      "Classe Digitale La Responsabilité Manageriale",
      "Classe Digitale Manager les Démissions",
      "Classe Digitale Le Futur du Management à l'Ère de l'IA",
      "Classe Digitale La Loi de la Semence",
      "Classe Digitale Agilité Décisionnelle",
      "Classe Digitale Devenir Chef de Service 5.0",
      "Classe Digitale Capacité d'Adaption à l'Ère de l'IA",
      "Classe Digitale Devenir un Manager/Dirigeant AI-Ready",
      "Classe Digitale Collaboration avec l'IA",
      "Classe Digitale Dirigeants 5.0",
      "Classe Digitale La Modélisation Commerciale Rendue Simple",
      "Classe Digitale Méthodes de Domination de Marché",
      "Classe Digitale Analyse & Planification Commerciales Optimisées IA",
      "Classe Digitale Le Coaching des Talents à l'Ère de l'IA",
      "Classe Digitale Le Dispositif de Pilotage Augmenté par l'IA",
      "Classe Digitale Bâtir son Équipe",
      "Classe Digitale Stratégies de Productivité Commerciale",
      "Classe Digitale Management de Projet Augmenté IA",
      "Classe Digitale L'IA pour les Managers Commerciaux 5.0",
      "Classe Digitale Bâtir une Équipe Engagée et Augmentée IA",
      "Classe Digitale Productivité Managériale Augmentée par l'IA",
      "Classe Digitale Secrets de Prise de Paroles en Public",
      "Classe Digitale L'Art de se Former à l'Ère de l'IA",
      "Classe Digitale Méthodes de Duplication Manageriale à l'Ère de l'IA",
      "Classe Digitale L'Art de Devenir Exceptionnelle",
      "Classe Digitale Manager les Absurdités",
      "Classe Digitale Intelligence Conceptuelle pour les Managers et Dirigeants",
      "Classe Digitale Réussir le Design Organisationnel",
      "Café Executive L'Art de Voir Plus Grand pour son Entreprise",
      "Café Executive Piloter l'Exécution Stratégique sans Excuses",
      "Café Executive Structurer son Audace de Dirigeant",
      "Café Executive L'Animation Commerciale qui Fait les Chiffres",
      "Classe Digitale Recruter ses Employés IA",
      "Classe Digitale L'Art d'Intégrer l'IA dans son Équipe",
      "Classe Digitale Structurer son Plan de Progression Professionnelle",
      "Classe Digitale Apprendre pour Performer à l'Ère de l'IA",
    ],
    benefits: [
      {
      ...
      {
        title: "48 sessions couvrant tous les enjeux managériaux",
